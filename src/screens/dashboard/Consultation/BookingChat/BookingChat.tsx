...
const BookingChat = ({ navigation }) => {
  const [messages, setMessages] = useState([
    { text: "Hello, Good morning", isMine: false, time: "19:40" },
    {
      text: "Looks like you were doing squats, and your genomic report says that you have a 78% risk of ligament and tendon injuries. We have choosen a specialized doctor for you to connect with.",
      isMine: false,
      time: "19:40",
    },
    {
      ...
      info: {
        name: "Dr. Alina Roy",
        position: "Expert Physician",
        img: "https://s3-alpha-sig.figma.com/img/e781/b355/0e0ea6ec2bafbd2f2cbd4fea9d8f0033?Expires=1724630400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=HBzeIHRp2OSjF3Pa3W8tYLy9SHq1fMGWkqk0ynvGqQIkpXOgePksqBf5ACdRA-Oiao4CdaT0fGNe0cNXKSYGKKsM1bVji1zPNmOKJn9HCnKgV7BC4eCGmQVvOpHZ1tQySXgfhjloqXXY12zs1F498qMDC-xFVU6U~YCiXIa3lNCObFu36OEnw6LVkId8ORk2hf7vCu-erwPIg9~yki19ZMMC3ZAe6a87Kwfz9VYg0WNnAAjmUeXyo2xyyNC07TRyf0J5jZNsnjy72srFI8EjNt2647PZ3BJUW9LcBJoEnLTdNVLCYDfubLgBOAiDcCkLIQ0Q5ToEJUm5dYCE~z4HPw__",
        skills: ["#Clinical Therapy", "#Nutrition", "#Physioexpert"],
        desc: "You Are going to actively pursue a better life, and take better care of my mind, body and soulI decided I was going to actively pursue a better life, and take better care of my mind, body and soul",
      },
      isMine: false,
      time: "19:40",
    },
